...
:class:`~src.clients.clubspark.ClubSparkClient`.  The Better.com
functions delegate to :class:`~src.clients.better_com.BetterClient`,
...
from src.apps.tennis_court_booker.models import (
    BookingResult,
    CardDetails,
    CourtSlot,
    VenueAvailability,
)
from src.clients.better_com.client import BetterClient
from src.clients.clubspark.client import ClubSparkClient, RawSlot
...
def _better_raw_to_court_slot(raw: dict[str, Any], date: datetime.date) -> CourtSlot | None:
    ...
    Args:
        raw: A slot dictionary as returned by
            :meth:`~src.clients.better_com.BetterClient.get_availability`.
        date: The date on which the slot falls.
    ...
    *,
    ...
    Args:
        ...
        client: Optional pre-constructed
            :class:`~src.clients.clubspark.ClubSparkClient`
...
async def get_venue_availability_better(
    ...
    *date*, converts them to domain objects, and optionally filters by
    ...
    The underlying :class:`~src.clients.better_com.BetterClient`
    ...
    Args:
        ...
        client: Optional pre-authenticated
            :class:`~src.clients.better_com.BetterClient`
            instance.  When ``None`` a default client is created and
            :meth:`~src.clients.better_com.BetterClient.ensure_logged_in`
...
async def book_court_clubspark(
    ...
    *,
    ...
    :meth:`~src.clients.clubspark.ClubSparkClient.book_slot`:
