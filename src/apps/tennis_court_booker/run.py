...
from src.apps.tennis_court_booker.card_credentials import CardCredentialHelper
from src.apps.tennis_court_booker.config import (
    get_default_venue_configs,
    get_valid_court_start_times,
)
from src.apps.tennis_court_booker.models import CardDetails, VenueConfig
from src.apps.tennis_court_booker.service import (
    book_court_better,
...
from src.clients.clubspark.credentials import ClubSparkCredentialHelper

if TYPE_CHECKING:
    from src.apps.tennis_court_booker.models import VenueAvailability
...
def _resolve_clubspark_credentials() -> tuple[str, str]:
    ...
    Delegates to
    :meth:`~src.clients.clubspark.credentials.ClubSparkCredentialHelper.get_credentials`.
